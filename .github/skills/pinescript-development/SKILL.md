...
* **`references/concepts/execution_model.md`**
...
* **`references/reference/variables.md`**
...
* **`references/reference/constants.md`**
...
* **`references/reference/keywords.md`**
...
* **`references/reference/functions/ta.md` (Technical Analysis)**
...
* **`references/reference/functions/strategy.md` (Backtesting)**
...
* **`references/reference/functions/request.md` (External Data)**
...
* **`references/reference/functions/drawing.md` (Visuals)**
...
* **`references/reference/functions/collections.md` (Arrays, Maps, Matrices)**
  * **Content:** Advanced data structures for complex logic.
  * **Keywords:** `array.new`, `array.push`, `matrix.new`, `matrix.mult`, `map.new`, `map.put`.

* **`references/reference/functions/general.md` (Math, Strings, Inputs)**
...
* **IF** user asks "Write an RSI indicator":
  * retrieve `references/reference/functions/ta.md` (for RSI math)
  * retrieve `references/reference/functions/drawing.md` (for `plot` and `hline`)

* **IF** user asks "Create a moving average crossover strategy":
  * retrieve `references/reference/functions/ta.md` (for `ta.crossover`)
  * retrieve `references/reference/functions/strategy.md` (for `strategy.entry`)

* **IF** user asks "Draw a box around the high and low of the last 10 bars":
  * retrieve `references/reference/functions/drawing.md` (for `box.new`)
  * retrieve `references/reference/functions/ta.md` (for `ta.highest`, `ta.lowest`)

* **IF** user asks "Why is my variable resetting every bar?":
  * retrieve `references/concepts/execution_model.md` (check `var` usage)
